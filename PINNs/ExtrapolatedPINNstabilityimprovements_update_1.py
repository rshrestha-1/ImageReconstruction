...
alpha_phys = 1e-4  # initial weight
...
onedrive_path = os.path.expanduser(
    '~/OneDrive - Imperial College London/PINN/H_extrapolated_time.mat'
)

# Save the MATLAB data
savemat(onedrive_path, {
    'H_new': H_new,
    'Nx': Nx_new,
    'Ny': Ny_new,
    'Nz': Nz_new,
    'total_loss_history': loss_total_hist,
    'data_loss_history': loss_data_hist,
    'physics_loss_history': loss_phys_hist
})

print(f"Saved final time-domain extrapolated H to OneDrive at:\n{onedrive_path}")
