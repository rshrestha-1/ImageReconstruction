...
alpha_phys = 1e-3  # initial weight
alpha_increase_every = 500  # epochs
alpha_factor = 2.0  # multiply weight gradually
...
for epoch in range(3000):
    ...
    if epoch % alpha_increase_every == 0 and epoch > 0:
        alpha_phys *= alpha_factor  # <- Marker 3: increase physics weight
